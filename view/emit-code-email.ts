const baseEmailCodeString = function (userName: string, code: string) {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <center>
      <table>
        ...
        <tr>
          <td class="introduction" style="padding-bottom: 20px">A password change has been initiated for your account. Your code is: </td>
        </tr>
        <tr>
          <td
            class="regards"
            style="text-align: center; font-weight: bold; color: black; font-size: medium;padding-bottom: 20px;"
          >
            ${code.split("")[0]} ${code.split("")[1]} ${code.split("")[2]} ${code.split("")[3]}
          </td>
        </tr>
        <tr>
